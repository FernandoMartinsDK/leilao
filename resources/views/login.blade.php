...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1"><a class="btn btn-outline-primary ms-auto" role="button" href="#">Registrar</a><button class="btn btn-primary" type="button" style="margin-left: 15px;">Logar</button></div>
        </div>
    </nav>
                ...
                <div class="col">
                    <div class="wrapper">
                        ...
                        <form class="p-3 mt-3">
                            ...
                            <button class="btn mt-3">Logar</button>
                        </form>
